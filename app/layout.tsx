...
export const metadata: Metadata = {
  ...
  title: "Carvatel | Soluciones tecnológicas, soporte Zebra y Motorola en Quito",
  description:
    "Carvatel ofrece soluciones tecnológicas empresariales, servicio técnico Zebra, soporte para radios Motorola, venta de equipos y soluciones de software en Quito, Ecuador.",
  keywords: [
    "Carvatel",
  ...
  openGraph: {
    ...
    description:
      "Soporte técnico, equipos Zebra y Motorola, y soluciones empresariales en Quito, Ecuador.",
    type: "website",
    locale: "es_EC",
