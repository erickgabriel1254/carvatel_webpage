...
const links = [["Nosotros","#nosotros"],["Servicios","#servicios"],["Soluciones","#soluciones"],["Equipos","#equipos"],["Contacto","#contacto"]];
  ...
  return (
    <footer className="bg-[#15191F] pb-8 pt-16 text-gray-400">
      <div className="container-page grid gap-10 border-b border-white/10 pb-12 md:grid-cols-[1.4fr_.7fr_1fr]">
        ...
        <div><h2 className="font-extrabold text-white">Enlaces</h2><nav className="mt-5 flex flex-col gap-3" aria-label="Enlaces del pie">{links.map(([label,href]) => <a key={href} href={href} className="text-sm hover:text-white">{label}</a>)}</nav></div>
